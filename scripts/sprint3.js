...
function correggi() {
    ...
    if(document.querySelector('input[name="dimensioni_team"]:checked').value.localeCompare("singolare")) {
        ...
        addOutcome('FunnelMarketing','fm', db.funnelMarketing,"Modalità Adv per portare traffico alla landing",true);
        ...
        addOutcome('FunnelMarketing','fm', db.funnelMarketing,"Modalità Adv per portare traffico alla landing",false);
